return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>mc", "<Plug>(git-conflict-ours)", { desc = "Current(Ours) Change" })
      vim.keymap.set("n", "<leader>mi", "<Plug>(git-conflict-theirs)", { desc = "Incoming(Theirs) Change" })
      vim.keymap.set("n", "<leader>mb", "<Plug>(git-conflict-both)")
      vim.keymap.set("n", "<leader>m0", "<Plug>(git-conflict-none)")
      vim.keymap.set("n", "<leader>mC", "<Plug>(git-conflict-all-ours)", { desc = "Current(Ours) Change" })
      vim.keymap.set("n", "<leader>mI", "<Plug>(git-conflict-all-theirs)", { desc = "Incoming(Theirs) Change" })
      vim.keymap.set("n", "<leader>mB", "<Plug>(git-conflict-all-both)")
      vim.keymap.set("n", "<leader>mN", "<Plug>(git-conflict-all-none)")
